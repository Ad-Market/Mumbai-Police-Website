    ...
    <body>
        ...
        <div class="header">
            <h1 style="height: 200px; top: 0px; left: 0px; width: 1254px;">
                <img src="logo.gif" style="height: 201px; width: 240px;
        ...
        <div class="topnav">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="mission.jsp">Our Mission</a>
                    <a href="Our History.jsp">Our History</a>
                  
                </div>
            </div>
           
            <a href="#" >New Programs</a>
            <%
            ...
            %>
            <a href="Register.html">Citizen Registration</a>
            ...
            %>
            <a href="addcomp.html" >E-Complaint</a>
            <div class="dropdown">
                <button id = "myaccount" class="dropbtn">
                    <%=session.getAttribute("email")%>
                </button>
                <div class="dropdown-content">
                    <a href="update.jsp">My Profile</a>
